...
export interface ApiAccountAccount extends Schema.CollectionType {
  ...
  attributes: {
    ...
    tipo_cuenta: Attribute.Enumeration<['ahorros', 'corriente']> &
      Attribute.Required &
      Attribute.DefaultTo<'ahorros'>;
    saldo: Attribute.Integer &
      Attribute.Required &
      Attribute.SetMinMax<
        {
          min: 0;
    ...
    owner_id: Attribute.Relation<
      'api::account.account',
      'manyToOne',
      'api::client.client'
    >;
    movimientos: Attribute.Relation<
      'api::account.account',
      'oneToMany',
...
export interface ApiClientClient extends Schema.CollectionType {
  ...
  attributes: {
    ...
    pais: Attribute.Enumeration<['colombia', 'usa']> & Attribute.Required;
    ciudad: Attribute.Enumeration<
      ['medellin', 'bogota', 'cali', 'miami', 'persona_juridica']
    > &
      Attribute.Required;
    ...
    tipo_documento: Attribute.Enumeration<['cc', 'pp', 'nit']> &
      Attribute.Required &
    ...
    tipo_cliente: Attribute.Enumeration<
    ...
    accounts: Attribute.Relation<
      ...
      'api::account.account'
    >;
    clave: Attribute.String & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiMovimientoMovimiento extends Schema.CollectionType {
  ...
  attributes: {
    tipo_movimiento: Attribute.Enumeration<['ingreso', 'egreso']>;
